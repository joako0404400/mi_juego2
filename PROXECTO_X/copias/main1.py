...
# Cargar imágenes
fondo = pygame.image.load("entorno_pygame/juego/assets/fondo.png")  # Ruta de tu imagen de fondo
fondo = pygame.transform.scale(fondo, (ANCHO, ALTO))
pajaro_imagen = pygame.image.load("entorno_pygame/juego/assets/pajaro.png")  # Ruta de la imagen de tu pájaro

# Escalar la imagen del pájaro al tamaño deseado
pajaro_imagen = pygame.transform.scale(pajaro_imagen, (50, 50))  # Ajusta el tamaño
...
# Escalar las imágenes de los enemigos al tamaño deseado
enemigo1_imagen = pygame.transform.scale(enemigo1_imagen, (50, 50))  # Ajusta el tamaño
enemigo2_imagen = pygame.transform.scale(enemigo2_imagen, (50, 50))  # Ajusta el tamaño
...
# Reproducir la música de fondo en bucle (para que se repita continuamente)
musica_fondo.play(-1)
